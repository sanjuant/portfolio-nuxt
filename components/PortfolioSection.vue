      ...
      <div class="grid grid-cols-10 gap-4">
        ...
        >
          ...
          >
            ...
            <swiper-slide
                v-for="(project, index) in error ? projects : portfolios.data"
              ...
              >
                <div @click="controlledSwiper.slideTo(index)">
                  <img
                      ...
                      :src="error ? project.attributes.cover.data.attributes.url : `${$config.public.strapiUrl}${project.attributes.cover.data.attributes.url}`"
                      :alt="error ? project.attributes.cover.data.attributes.alternativeText : project.attributes.cover.data.attributes.alternativeText"
                  />
                </div>
        ...
        >
          ...
          >
            <swiper-slide
                v-for="project in error ? projects : portfolios.data"
                :key="project.attributes.title"
                class="max-w-full p-1"
            >
              <div
              ...
              <swiper
                  ...
                  class="z-40 mt-4 w-full"
                  nested
              >
                <template #wrapper-start></template>
                <swiper-slide
                    v-for="pimg in project.attributes.previews.data"
                    :key="pimg.attributes.url"
                    class="max-w-full"
                >
                  <img
                      class="h-24 rounded-md w-full object-cover border border-gray-100 dark:border-slate-800"
                      :src="error ? pimg.attributes.url : `${$config.public.strapiUrl}${pimg.attributes.url}`"
                      :alt="error ? pimg.attributes.alternativeText : pimg.attributes.alternativeText"
                  />
                </swiper-slide>
                <template #wrapper-end></template>
                <div class="sbutton-prev flex justify-center">
